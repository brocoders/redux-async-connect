...
// If you use immutable, don't forget to use seleceLoadedState in props
// const select = (state) => state.get('reduxAsyncConnect').loaded
// <ReduxAsyncConnect {...props} selectLoadedState={select}/>}
render((
...
app.get('*', (req, res) => {
  ...
  match({ routes, location: req.url }, (err, redirect, renderProps) => {
    ...
    loadOnServer(renderProps, store).then(() => {
      ...
      // const appHTML = renderToString(
      //  <Provider store={store} key="provider">
      //    <ReduxAsyncConnect {...renderProps} selectLoadedState={select}/> />
      //  </Provider>
      // )
